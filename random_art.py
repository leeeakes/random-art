    ...
    def evaluate(self, x, y):
        ...
        for (command, coord) in self.commands:
            if command == "sin" and coord == "x":
                value *= math.exp(math.sin(math.tan(math.sin(math.tan(math.e * x)))))
            elif command == "sin" and coord == "y":
                value *= math.exp(math.sin(math.tan(math.sin(math.tan(math.e * y)))))
            elif command == "cos" and coord == "x":
                value *= math.cos(math.exp(math.cos(math.tan(math.e * x))))
            elif command == "cos" and coord == "y":
                value *= math.cos(math.exp(math.cos(math.tan(math.e * y))))
